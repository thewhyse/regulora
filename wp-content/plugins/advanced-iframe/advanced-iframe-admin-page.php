...
<?php
    ...
    $showRegMessage = empty($devOptions['purchase_code']);
	if ($evanto && $showRegMessage) {  
		...
		echo  __('<p>Thank you for installing advanced iframe pro. Please enter your purchase code on the <a href="#" class="enter-registration">options tab</a>. It will unlock all the additional features you purchased.</p>', 'advanced-iframe');
		echo '</strong></p></div>';
	} 
