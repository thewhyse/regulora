...
if (!empty($hide_content_until_iframe_color)) {
    ...
    $hide_content_until_content =  '<div style="width:100%;height:100%;position:fixed;z-index:999;top:0px;left:0px;background-color:'.esc_html($hide_content_until_iframe_color_print).';" id="ai-div-hide-content-'.$id.'"><!-- hides the content '.current_action().' --></div>'; 
