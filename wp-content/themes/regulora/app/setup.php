...
add_action('after_setup_theme', function () {
     ...
     * Colors define
     */
    define( 'COLOR_PRIMARY', '#285873' );
    define( 'COLOR_SECONDARY', '#83d1ee' );
    define( 'COLOR_BLUE', '#0c7ea2' );
    define( 'COLOR_GRAY', '#acbcc7' );
    define( 'COLOR_BLACK', '#191919' );
...
add_action('widgets_init', function () {
    ...
    register_sidebar([
        'name'          => __('Mobile Menu Eyebrow', 'sage'),
        'id'            => 'sidebar-menu'
    ] + $config);
    register_sidebar([
        'name'          => __('Footer', 'sage'),
