...
function regulora_patient_site_assets() {
	...
	wp_register_style( 'reg_patient_site_stylesheet', get_theme_file_uri() . '/dist/styles/main_' . $pat . '.css');
	wp_enqueue_style('reg_patient_site_stylesheet', false);

/*	wp_register_style( 'reg_patient_site_stylesheet', get_theme_file_uri() . '/dist/styles/main_ff9ffa61.css', false);
...
add_action('wp_head', 'regulora_patient_site_assets');
