...
function regulora_patient_site_assets() {
	...
	wp_register_style( 'reg_patient_site_stylesheet', get_theme_file_uri() . '/dist/styles/main_' . $pat . '.css' . '_wass-wtf-is-that', false);
	wp_enqueue_style('reg_patient_site_stylesheet', false, false, false, 'print');
